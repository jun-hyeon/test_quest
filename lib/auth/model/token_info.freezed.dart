...
mixin _$TokenInfo {
 ...
 String get token; int get expiresIn;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TokenInfo&&(identical(other.token, token) || other.token == token)&&(identical(other.expiresIn, expiresIn) || other.expiresIn == expiresIn));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String token,  int expiresIn)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TokenInfo() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String token,  int expiresIn)  $default,) {final _that = this;
switch (_that) {
case _TokenInfo():
return $default(_that.token,_that.expiresIn);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String token,  int expiresIn)?  $default,) {final _that = this;
switch (_that) {
case _TokenInfo() when $default != null:
return $default(_that.token,_that.expiresIn);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TokenInfo&&(identical(other.token, token) || other.token == token)&&(identical(other.expiresIn, expiresIn) || other.expiresIn == expiresIn));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AccessResponseCopyWith<AccessResponse> get copyWith => _$AccessResponseCopyWithImpl<AccessResponse>(this as AccessResponse, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AccessResponse&&(identical(other.access, access) || other.access == access));
}
...
abstract mixin class $AccessResponseCopyWith<$Res>  {
  factory $AccessResponseCopyWith(AccessResponse value, $Res Function(AccessResponse) _then) = _$AccessResponseCopyWithImpl;
@useResult
$Res call({
 TokenInfo access
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AccessResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AccessResponse value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AccessResponse value)?  $default,){
final _that = this;
switch (_that) {
case _AccessResponse() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TokenInfo access)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccessResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TokenInfo access)  $default,) {final _that = this;
switch (_that) {
case _AccessResponse():
return $default(_that.access);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TokenInfo access)?  $default,) {final _that = this;
switch (_that) {
case _AccessResponse() when $default != null:
return $default(_that.access);case _:
  return null;
...
class _AccessResponse implements AccessResponse {
  ...
  factory _AccessResponse.fromJson(Map<String, dynamic> json) => _$AccessResponseFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$AccessResponseCopyWith<_AccessResponse> get copyWith => __$AccessResponseCopyWithImpl<_AccessResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AccessResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AccessResponse&&(identical(other.access, access) || other.access == access));
}
...
/// @nodoc
abstract mixin class _$AccessResponseCopyWith<$Res> implements $AccessResponseCopyWith<$Res> {
  factory _$AccessResponseCopyWith(_AccessResponse value, $Res Function(_AccessResponse) _then) = __$AccessResponseCopyWithImpl;
@override @useResult
$Res call({
 TokenInfo access
});
...
@override $TokenInfoCopyWith<$Res> get access;
