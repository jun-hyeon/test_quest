...
mixin _$SignupForm {
 ...
 String get email; String get password; String get nickname; String get name; String? get profileImage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,email,password,nickname,name,profileImage);
...
@useResult
$Res call({
 String email, String password, String nickname, String name, String? profileImage
});
...
/// Create a copy of SignupForm
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? password = null,Object? nickname = null,Object? name = null,Object? profileImage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String password,  String nickname,  String name,  String? profileImage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignupForm() when $default != null:
return $default(_that.email,_that.password,_that.nickname,_that.name,_that.profileImage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String password,  String nickname,  String name,  String? profileImage)  $default,) {final _that = this;
switch (_that) {
case _SignupForm():
return $default(_that.email,_that.password,_that.nickname,_that.name,_that.profileImage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String password,  String nickname,  String name,  String? profileImage)?  $default,) {final _that = this;
switch (_that) {
case _SignupForm() when $default != null:
return $default(_that.email,_that.password,_that.nickname,_that.name,_that.profileImage);case _:
  return null;
...
class _SignupForm implements SignupForm {
   _SignupForm({required this.email, required this.password, required this.nickname, required this.name, this.profileImage});
...
/// Create a copy of SignupForm
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? password = null,Object? nickname = null,Object? name = null,Object? profileImage = freezed,}) {
